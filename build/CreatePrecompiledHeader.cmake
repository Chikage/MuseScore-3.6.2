    ...
    if (NOT "${CMAKE_GENERATOR}" STREQUAL "Xcode")
        ...
        if (APPLE)
            ...
            foreach( item ${${includes}} )
                if (item AND NOT "${item}" MATCHES "^\\$<" AND NOT "${item}" MATCHES "framework$")
        ...
        # CMAKE_CXX_STANDARD is translated into a target compile option by
        # CMake, so it is not present in CMAKE_CXX_FLAGS. The shared PCH is
        # generated by a custom command and must receive the same option
        # explicitly or Clang will reject it when target sources use C++17.
        if (NOT MSVC AND CMAKE_CXX_STANDARD)
