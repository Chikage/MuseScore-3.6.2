...
if(QT_INSTALL_PREFIX)
    ...
    if(EXISTS "${QT_INSTALL_PREFIX}/lib/cmake/Qt5/Qt5Config.cmake")
        set(Qt5_DIR "${QT_INSTALL_PREFIX}/lib/cmake/Qt5" CACHE PATH "Qt5 CMake package directory" FORCE)
    endif()
    foreach(_component ${_components})
        if(EXISTS "${QT_INSTALL_PREFIX}/lib/cmake/Qt5${_component}/Qt5${_component}Config.cmake")
            set(Qt5${_component}_DIR "${QT_INSTALL_PREFIX}/lib/cmake/Qt5${_component}" CACHE PATH "Qt5 ${_component} CMake package directory" FORCE)
        endif()
    endforeach()
